...
#include "GALAGA__USFX_L01Projectile.h"
...
const FName AGALAGA__USFX_L01Pawn::MoveRightBinding("MoveRight");
const FName AGALAGA__USFX_L01Pawn::FireForwardBinding("FireForward");
const FName AGALAGA__USFX_L01Pawn::FireRightBinding("FireRight");

AGALAGA__USFX_L01Pawn::AGALAGA__USFX_L01Pawn()
{	
...
void AGALAGA__USFX_L01Pawn::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
...
void AGALAGA__USFX_L01Pawn::Tick(float DeltaSeconds)
{
...
void AGALAGA__USFX_L01Pawn::FireShot(FVector FireDirection)
{
	...
	if (bCanFire == true)
	{
		...
		if (FireDirection.SizeSquared() > 0.0f)
		{
			...
			const FVector SpawnLocation2 = GetActorLocation() + FireRotation.RotateVector(GunOffset);

			UWorld* const World = GetWorld();
			if (World != nullptr)
			{
				// spawn the projectile
				World->SpawnActor<AGALAGA__USFX_L01Projectile>(SpawnLocation, FireRotation);
			}
...
void AGALAGA__USFX_L01Pawn::ShotTimerExpired()
{
	bCanFire = true;
}
